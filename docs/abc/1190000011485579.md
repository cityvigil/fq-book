...
*****************************************************
zhouzhou:~ zhou$ ssh -D 7001 oracle@192.168.56.101
oracle@192.168.56.101's password:
Last login: Mon Feb 26 15:33:05 2024 from 192.168.56.1
[oracle@client101 ~]$ df -h
*****************************************************
zhouzhou:~ zhou$ netstat -ant |grep 192.168.56.101
tcp4       0      0  192.168.56.1.52405     192.168.56.101.22      ESTABLISHED
zhouzhou:~ zhou$ netstat -ant |grep 7001
